...
public class TestCassandraPermissionsDAO
{
    ...
    public void before() throws Exception
    {
        ...
        // .build()
        // .connect();
        // permissionsDAO = new CassandraPermissionsDAO(session, "permissions",
        // true);
...

        {
            ...
            Stream<String> childAuthsStream = permissionsDAO.getChildAuthoritiesAsStream("Root", null, null);
...

        {
            ...
            Stream<String> rootContainedAuthsStream = permissionsDAO
                    .getContainedAuthoritiesAsStream("Root", null, null);
    ...
    public void test1() throws Exception
    {
//        permissionsDAO.addAssoc("parent1", 1, "Children", "Read", "GROUP_1", "child2", 1);
        permissionsDAO.addAssoc("parent1", 1, "Children", "child2", 1);
    ...
    {
//        permissionsDAO.addAssoc("parent1", 1, "Children", "Read", "GROUP_2", "child2",
//                1);
        permissionsDAO.addAssoc("parent1", 1, "GROUP_2", "child2", 1);

        {
            List<Node> children = permissionsDAO.getChildren("parent1", 1, "GROUP_1", 0, 10);
            assertEquals(0, children.size());
        }
