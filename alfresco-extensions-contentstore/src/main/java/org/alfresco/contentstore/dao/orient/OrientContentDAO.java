...
//	{
//		doc.field("p", nodeInfo.getNode().getNodePath());
//		doc.field("c", nodeInfo.getContentPath());
//		doc.field("n", nodeInfo.getNode().getNodeId());
//		doc.field("v", nodeInfo.getNode().getNodeVersion());
...
//		String versionLabel = doc.field("v");
//		String mimeType = doc.field("m");
//		Long size = doc.field("s");
//
//		NodeInfo nodeInfo = new NodeInfo(Node.build()
...
//				ODocument doc = getDocByNodeId(nodeId, versionLabel);
...
//
//	@Override
//    public NodeInfo getByNodeId(String nodeId, long nodeInternalVersion,
//            boolean isPrimary)
//    {
//	    // TODO Auto-generated method stub
//	    return null;
...
//
//    @Override
//    public boolean nodeExists(String nodeId, long nodeInternalVersion, boolean isPrimary)
//    {
//        // TODO Auto-generated method stub
//        return false;
//    }
