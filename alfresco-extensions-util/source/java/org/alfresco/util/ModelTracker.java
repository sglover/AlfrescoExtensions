...
public class ModelTracker
{
    ...
    public ModelTracker(DictionaryDAO dictionaryDAO, NamespaceDAO namespaceDAO, SOLRAPIClient solrAPIClient)
    {
...
//    }
    ...
    {
        final String prefix = modelName.toPrefixString(namespaceDAO).replace(":", ".") + ".";
    ...
    public void trackModels() throws AuthenticationException, IOException, JSONException
    {
    	...
    	try
    	{
	        List<AlfrescoModelDiff> modelDiffs = solrAPIClient.getModelsDiff(Collections.<AlfrescoModel>emptyList());
	        ...
	        for (AlfrescoModelDiff modelDiff : modelDiffs)
	        {
	            ...
	            {
	            case CHANGED:
	                AlfrescoModel changedModel = solrAPIClient.getModel(modelDiff.getModelName());
	                ...
	                break;
	            case NEW:
	                AlfrescoModel newModel = solrAPIClient.getModel(modelDiff.getModelName());
