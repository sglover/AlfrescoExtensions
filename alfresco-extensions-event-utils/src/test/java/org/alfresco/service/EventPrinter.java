...
public class EventPrinter
{
	...
	public void before() throws Exception
	{
		...
		this.events = new Events("activemq:topic:ActiveMQ.Advisory.Consumer.Topic.alfresco.repo.events.nodes", eventListener);
	}

	@Test
	public void test1() throws Exception
	{
//	       ConnectionFactory out = new ActiveMQConnectionFactory("tcp://http://172.29.102.6/:61616?jms.prefetchPolicy.all=10000");
	    //?jms.prefetchPolicy.all=10000
	    ConnectionFactory out = new ActiveMQConnectionFactory("tcp://ec2-54-170-12-65.eu-west-1.compute.amazonaws.com:61616");
	    ...
	    { 
	        ...
	        List<MessageDispatch> msgList = ((ActiveMQSession) session).getUnconsumedMessages();

	        System.out.println( "\nQueue = " + q_name);
	        if(q_name.equals("ActiveMQ.Advisory.Consumer.Topic.alfresco.repo.events.nodes"))
...
//		final AmqpDirectEndpoint endpoint = AmqpNodeBootstrapUtils.createEndpoint(messageConsumer, broker,
...
//                	List<List<String>> parentNodeIds = Arrays.asList(Arrays.asList(GUID.generate(), GUID.generate(),
//                			GUID.generate()));
//            		List<List<String>> toParentNodeIds = Arrays.asList(Arrays.asList(GUID.generate(),
...
//            			if(j == 1)
//            			{
//	            			event = new NodeAddedEvent(seqNumber(), nodeName, txnId, System.currentTimeMillis(),
...
//            				if(i % 2 == 0)
//            				{
//		            			event = new NodeMovedEvent(seqNumber(), nodeName, newName, txnId, System.currentTimeMillis(),
//		            					null, null, nodeId, "cm:document", paths, parentNodeIds, "user1",
...
//            				else
//            				{
//		            			event = new NodeRenamedEvent(seqNumber(), nodeName, newName, txnId, System.currentTimeMillis(),
//		            					null, null, nodeId, "cm:document", paths, parentNodeIds, "user1",
...
//            			else
//            			{
//	            			event = new NodeUpdatedEvent(seqNumber(), nodeName, txnId, System.currentTimeMillis(),
...
//            		TransactionCommittedEvent event = new TransactionCommittedEvent(seqNumber(), txnId, null,
