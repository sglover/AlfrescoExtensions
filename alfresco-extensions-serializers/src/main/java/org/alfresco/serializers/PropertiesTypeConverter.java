 ...
 * 
 */
public class PropertiesTypeConverter extends TypeConverter
{
    private static Log logger = LogFactory.getLog(PropertiesTypeConverter.class);

    /**
     * Default Type Converter
     */
    public static TypeConverter INSTANCE = new PropertiesTypeConverter();
