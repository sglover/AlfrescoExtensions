 ...
 *
 */
public class TextContentAvailableEvent implements Serializable
{
	...
	public TextContentAvailableEvent()
	{
	}

	public TextContentAvailableEvent(String cacheServerId, String nodeId, String nodeVersion, String nodePath, String mimeType,
