...
import org.alfresco.cacheserver.camel.CacheServerNodeEventListener;
 ...
 */
@Component
public class CacheServerEventsRouteBuilder extends RouteBuilder
{
    private static Log logger = LogFactory.getLog(CacheServerEventsRouteBuilder.class);
    ...
    @Autowired
    public CacheServerEventsRouteBuilder(@Qualifier("nodeEventListener") CacheServerNodeEventListener eventListener,
